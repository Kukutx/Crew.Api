...
namespace Crew.Api.Migrations
{
    ...
    [Migration("20250924215436_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Crew.Api.Models.Authentication.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Crew.Api.Models.Comment", b =>
                {
                    ...
                    b.HasOne("Crew.Api.Models.DomainUsers", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Crew.Api.Models.Authentication.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
